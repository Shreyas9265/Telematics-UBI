...
# NOTE: package-relative imports (run: uvicorn src.api:app ...)
...
def health():
    ...
    return {
        ...
        "model_loaded": True,  # wire a real check if needed
    }
...
def bootstrap(req: BootstrapReq):
    ...
    return {
        ...
        "loaded": 0,
        "source": None,
        "message": "No CSV/NDJSON found; generation disabled.",
    }
...
def driver_score_compat(driver_id: str):  # backward-compat path typo guard if existed
    return driver_score(driver_id)
